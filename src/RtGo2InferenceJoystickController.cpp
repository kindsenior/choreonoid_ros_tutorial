...
class Go2InferenceJoystickController : public SimpleController
{
    // Joystick
    Joystick joystick;
...
public:
    ...
    virtual bool initialize(SimpleControllerIO* io) override
    {
        ...
        subscriber = node->subscribe("cmd_vel", 1, &Go2InferenceJoystickController::command_velocity_callback, this);    return true;
    ...
    virtual bool control() override
    {
        ...
        // controll velocity by Joystick
        static const int axisID[] = { 0, 1, 2 }; // S/F, E/D, J/L
        ...
        for(int i=0; i < 2; ++i){ // pos:-1~1, scale with vel_range
            command[0] = - lin_vel_x_range[1] * pos[1];
            command[1] = - lin_vel_y_range[1] * pos[0];
            command[2] = - ang_vel_range[1]   * pos[2];
        }
...
CNOID_IMPLEMENT_SIMPLE_CONTROLLER_FACTORY(Go2InferenceJoystickController)
